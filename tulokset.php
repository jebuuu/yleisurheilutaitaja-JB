...
<br>
<img alt="juoksu" src="/~T2017051002/sivu/img/vo_lahtotelineissa.jpg"<?php if(array_keys($tiedot, max($tiedot))[0]=="pikajuoksut"){echo 'style="max-width: 190px;max-height: 150px;margin:0;"';}?>>
</div>
<div class="ryhmat" id="ryhma2">
<h3>Kestävyyslajit</h3>
<h2><?php echo $tiedot['kestavyys'];?></h2>
<br>
<img alt="juoksu" src="/~T2017051002/sivu/img/vo_juoksu.jpg"<?php if(array_keys($tiedot, max($tiedot))[0]=="kestavyys"){echo ' style="max-width: 190px;max-height: 150px;margin:0;"';}?>>
</div>
<div class="ryhmat" id="ryhma3">
<h3>Hypyt</h3>
<h2><?php echo $tiedot['hypyt'];?></h2>
<br>
<img alt="hyppy" src="/~T2017051002/sivu/img/pituus6b.jpg"<?php if(array_keys($tiedot, max($tiedot))[0]=="hypyt"){echo ' style="max-width: 190px;max-height: 150px;margin:0;"';}?>>
</div>
<div class="ryhmat" id="ryhma4">
<h3>Heitot</h3>
<h2><?php echo $tiedot['heitot'];?></h2>
<br>
<img alt="heitto" src="/~T2017051002/sivu/img/kiekko7a.jpg"<?php if(array_keys($tiedot, max($tiedot))[0]=="heitot"){echo ' style="max-width: 190px;max-height: 150px;margin:0;"';}?>>
</div>
</div>
<br>
	<?php if(isset($_POST['laske'])){?>
		<form method="post" action="/~T2017051002/sivu/?sivu=tallenna" id="formi">
